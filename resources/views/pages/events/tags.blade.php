...
@section('content')
    ...
    <div class="container">
        ...
        <h1 class="h2 text-center black uppercase black">Events Associted With Tag {{  $slug }}</h1>
            ...
            @foreach($events as $event)
                <div class="container">
                    ...
                    <div class="col-md-5 mtop10">
                        <div class="fontsize16 bold gold ellipsis"><a href="{{ route('events.show', $event->slug) }}" title="{{ $event->name }}" class="gold decorationoff">{{ $event->name }}</a></div>
