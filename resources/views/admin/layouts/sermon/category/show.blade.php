                            ...
                            <div class="panel-footer">
                                    <span class="pull-left">
                                        @if(Auth::guard('admin')->user()->can('update-admin-sermon-category-controller'))
                                            <a href="{{ route('admin.category.edit', $category->slug) }}" data-original-title="Edit category info" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                                        @endif
                                    </span>
