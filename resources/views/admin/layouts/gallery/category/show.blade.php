...
@section('page_title', 'View'. $category->name.'Gallery Category')
@section('header')
                            ...
                            <div class="panel-footer">
                                    <span class="pull-left">
                                        @if(Auth::guard('admin')->user()->can('update-admin-gallery-category-controller'))
                                            <a href="{{ route('admin.gallery-categories.edit', $category->slug) }}" data-original-title="Edit category info" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                                        @endif
                                    </span>
