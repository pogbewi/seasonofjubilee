...
return [
    ...
    'taggedModels' => [
        'events' => \Seasonofjubilee\Models\Event::class,
        'sermons' => \Seasonofjubilee\Models\Sermon::class,
        'testimonies' => \Seasonofjubilee\Models\Testimony::class,
        'posts' => \Seasonofjubilee\Models\Post::class,
        'galleries' => \Seasonofjubilee\Models\Gallery::class
    ],
